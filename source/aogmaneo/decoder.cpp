    ...
    for (int hc = 0; hc < hidden_size.z; hc++) {
        ...
        for (int di = 0; di < num_dendrites_per_cell; di++) {
            ...
            for (int vli = 0; vli < visible_layers.size(); vli++) {
                ...
                float complemented = (sub_count_all - vl.dendrite_totals[dendrite_index] * byte_inv) - (sub_count - vl.dendrite_sums[dendrite_index] * byte_inv);
...
void Decoder::init_random(
    ...
    for (int i = 0; i < num_hidden_columns; i++) {
        ...
        for (int vli = 0; vli < visible_layers.size(); vli++) {
            ...
            vl.dendrite_counts[hidden_column_index] = sub_count;
