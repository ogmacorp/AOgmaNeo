...
private:
    ...
    void forward(
        ...
        Bundle<S, L> sum_all = 0.0f;
        Bundle<S, L> sum_pred = 0.0f;
        ...
        hidden_vecs_all[hidden_column_index] = (hidden_vecs_all[hidden_column_index] + hidden_vecs_all[hidden_column_index] * hidden_vec_all).thin().permute();
