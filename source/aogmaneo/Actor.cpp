...
void Actor::forward(
    ...
    int targetCPrev = (*hiddenTargetCIsPrev)[hiddenColumnIndex];

    float valuePrev = hiddenValues[address3(Int3(columnPos.x, columnPos.y, targetCPrev), hiddenSize)];
