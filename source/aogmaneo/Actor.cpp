...
void Actor::learn(
    ...
    for (int hc = 0; hc < hiddenSize.z; hc++) {
        ...
        float deltaAction = (mimic ? alr : (tdErrorValue > 0.0f ? alr : -alr)) * ((hc == targetCI) - hiddenActivations[hiddenCellIndex]);
...
void Actor::write(
    ...
    writer.write(reinterpret_cast<const void*>(&explore), sizeof(Byte));
...
void Actor::read(
    ...
    reader.read(reinterpret_cast<void*>(&explore), sizeof(Byte));
