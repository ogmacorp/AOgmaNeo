        ...
        if (l == 0) {
            ...
            for (int i = 0; i < io_sizes.size(); i++) {
                if (io_descs[i].type == prediction) {
                    ...
                    decoders[l][d_index].init_random(io_sizes[i], io_descs[i].num_locations, d_visible_layer_descs);
            ...
            for (int i = 0; i < io_sizes.size(); i++) {
                if (io_descs[i].type == action) {
                    ...
                    actors[d_index].init_random(io_sizes[i], io_descs[i].num_locations, io_descs[i].history_capacity, a_visible_layer_descs);
            ...
            // create decoders
            decoders[l][0].init_random(layer_descs[l - 1].hidden_size, layer_descs[l].num_locations, d_visible_layer_descs);
        }
