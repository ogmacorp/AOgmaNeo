...
void Encoder::forward(
    ...
    for (int hc = 0; hc < hidden_size.z; hc++) {
        ...
        if (hidden_matches[hidden_cell_index] > max_all_matche) {
            max_all_activation = hidden_matches[hidden_cell_index];
            max_all_index = hc;
        }
    }
    ...
    hidden_cis[hidden_column_index] = max_all_index;
}
