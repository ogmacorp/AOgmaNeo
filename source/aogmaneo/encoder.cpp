...
void Encoder::forward(
    ...
    hidden_acts[hidden_column_index] = max_activation;
}
...
void Encoder::learn(
    ...
    int target_ci = (hidden_acts[hidden_column_index] >= params.vigilance ? hidden_cis[hidden_column_index] : rand(state) % hidden_size.z);
