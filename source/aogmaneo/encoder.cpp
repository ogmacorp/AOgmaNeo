...
void Encoder::forward(
    ...
    // temporal
    {
        ...
        for (int tc = 0; tc < temporal_size; tc++) {
            ...
            float complemented = recurrent_sums[temporal_cell_index] * byte_inv - recurrent_totals[full_cell_index] * byte_inv + count_except;

            float match = (temporal_commit_flags[full_cell_index] ? complemented / count_except : 1.0f);
