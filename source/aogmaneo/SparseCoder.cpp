...
void SparseCoder::forward(
    ...
    if (learnEnabled) {
        for (int hc = 0; hc < hiddenSize.z; hc++) {
            ...
            float delta = alpha * (*hiddenErrors)[hiddenColumnIndex] * sigmoid((*hiddenErrors)[hiddenColumnIndex]) * ((hc == hiddenCIs[hiddenColumnIndex] ? 1.0f : 0.0f) - hiddenActivations[hiddenCellIndex]);
