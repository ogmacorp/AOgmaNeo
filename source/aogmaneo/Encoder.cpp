...
void Encoder::learn(
    ...
    for (int hc = 0; hc < hiddenSize.z; hc++) {
        ...
        float delta = lr * ((*hiddenErrors)[hiddenCellIndex] - reg * max(0.0f, numNonZero - 1.0f)) * (hiddenActivationsPrev[hiddenCellIndex] > 0.0f && hiddenActivationsPrev[hiddenCellIndex] < 1.0f);
