...
void Decoder::generateTargets(
    ...
    (*visibleTargets)[visibleColumnIndex] += sum / max(1, count);
}
...
void Decoder::generateTargets(
    ...
    for (int i = 0; i < numVisibleColumns; i++)
        generateTargets(Int2(i / vld.size.y, i % vld.size.y), hiddenTargetCIs, visibleTargets, vli);
}
